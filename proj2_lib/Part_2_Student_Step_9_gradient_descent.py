...
'''
This function uses the hinge loss for its loss function, and thus 
does not take in a loss function as one of its parameters
'''
def calculate_gradient_descent(x, y, num_iter, _lambda, learning_rate):
    b = 0
...
for k in range(1, K):
    ...
    _lambda = 1
    learning_rate = 0.1
    calculate_gradient_descent(X, Y, num_iter, _lambda,learning_rate)
